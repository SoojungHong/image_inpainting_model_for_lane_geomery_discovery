...
parser.add_argument('--hole_min_w', type=int, default=48)   #24
parser.add_argument('--hole_max_w', type=int, default=64)   #48
parser.add_argument('--hole_min_h', type=int, default=48)   #24
parser.add_argument('--hole_max_h', type=int, default=64)   #48
